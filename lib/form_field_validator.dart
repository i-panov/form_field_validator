...
abstract class FieldValidator<T> {
  ...
  const FieldValidator(this.errorText);
...
abstract class TextFieldValidator extends FieldValidator<String?> {
  const TextFieldValidator(super.errorText);
...
class EmailValidator extends TextFieldValidator {
  ...
  const EmailValidator({required String errorText}): super(errorText);
...
class DateValidator extends TextFieldValidator {
  ...
  const DateValidator(this.format, {
    required String errorText,
  }): super(errorText);
  ...
  bool isValid(String? value) {
    try {
      final DateTime? dateTime = DateFormat(format).tryParseStrict(value!);
...
class MatchValidator {
  ...
  const MatchValidator({required this.errorText});
